...
<p>Kaspa proves that the blockchain trilemma can be solved with better architecture.</p>`,
    ...
    const allQuestions: QuizQuestion[] = [
      ...
      { id: "q-2-1-1", lessonId: "lesson-2-1", question: "In a traditional blockchain, what happens when conflicts occur?", options: ["Both blocks are kept", "Blocks are merged", "One is accepted, one is orphaned", "Voting decides"], correctIndex: 2, explanation: "In linear chains, when conflicts occur, blocks are either accepted into the main chain or orphaned and discarded." },
      { id: "q-2-2-1", lessonId: "lesson-2-2", question: "What does DAG stand for?", options: ["Digital Asset Graph", "Directed Acyclic Graph", "Decentralized Autonomous Governance", "Distributed Account Gateway"], correctIndex: 1, explanation: "DAG stands for Directed Acyclic Graph - directed means edges have direction, acyclic means no cycles." },
      { id: "q-2-3-1", lessonId: "lesson-2-3", question: "If Block A is in the 'past' of Block B, what is Block B to Block A?", options: ["Also in the past", "In the future", "In the anticone", "Unrelated"], correctIndex: 1, explanation: "Past and Future are inverse relationships - if A is in B's past, then B is in A's future." },
      { id: "q-2-4-1", lessonId: "lesson-2-4", question: "What are 'anticone' blocks?", options: ["Invalid blocks", "Blocks that are neither ancestors nor descendants of each other", "Past blocks only", "Future blocks only"], correctIndex: 1, explanation: "Anticone describes blocks that exist concurrently - neither can reach the other through directed paths." },
      { id: "q-2-5-1", lessonId: "lesson-2-5", question: "What determines if a block is classified as 'Blue' vs 'Red'?", options: ["Block size", "Mining pool", "Anticone size relative to K parameter", "Transaction count"], correctIndex: 2, explanation: "GHOSTDAG classifies blocks as Blue (honest) or Red (potentially conflicting) based on anticone size constraints." },
      { id: "q-2-6-1", lessonId: "lesson-2-6", question: "What does the K parameter control in GHOSTDAG?", options: ["Block reward amount", "Maximum allowed anticone size for blue blocks", "Network latency", "Transaction fees"], correctIndex: 1, explanation: "K is the security parameter that controls maximum anticone size - blocks exceeding K are marked red." },
      { id: "q-2-7-1", lessonId: "lesson-2-7", question: "What is a 'Mergeset' in GHOSTDAG?", options: ["Discarded blocks", "Collection of blocks merged when creating a new block", "Orphan blocks", "Invalid transactions"], correctIndex: 1, explanation: "The mergeset is GHOSTDAG's collection of blocks that are merged together when a new block is created." },
      { id: "q-2-8-1", lessonId: "lesson-2-8", question: "What terminology does Bitcoin use that Kaspa replaces with DAG concepts?", options: ["Merkle trees", "'Previous block' becomes Past/Future/Anticone relationships", "Hash functions", "Digital signatures"], correctIndex: 1, explanation: "Bitcoin uses simple 'previous/next block' terminology, while Kaspa uses DAG concepts like Past, Future, Anticone, and Mergeset." },
      ...
      { id: "q-4-1-1", lessonId: "lesson-4-1", question: "Why can Kaspa achieve higher throughput than Bitcoin?", options: ["Larger blocks", "All valid parallel blocks are included, not orphaned", "More miners", "Faster internet"], correctIndex: 1, explanation: "The DAG structure allows all valid blocks to be included even if created simultaneously - no work is wasted." },
      { id: "q-4-2-1", lessonId: "lesson-4-2", question: "What are 'Tips' in DAG terminology?", options: ["Transaction fees", "Blocks that have no future blocks yet - the leading edge", "Invalid blocks", "Mining rewards"], correctIndex: 1, explanation: "Tips are blocks with no children yet - they are the 'leading edge' of the DAG." },
      { id: "q-4-3-1", lessonId: "lesson-4-3", question: "How does GHOSTDAG achieve agreement on transaction ordering?", options: ["Random selection", "By ordering all blocks despite parallel creation", "First-come-first-served", "Majority voting"], correctIndex: 1, explanation: "GHOSTDAG provides total ordering of all blocks even when created in parallel, enabling transaction consensus." },
      { id: "q-4-4-1", lessonId: "lesson-4-4", question: "What happens when a block violates K-cluster constraints?", options: ["It's deleted", "It's classified as 'Red' and excluded from main consensus", "Network rejects it", "Mining stops"], correctIndex: 1, explanation: "Blocks with anticone size exceeding K are marked 'red' - excluded from main consensus ordering." },
      { id: "q-4-5-1", lessonId: "lesson-4-5", question: "What does increasing BPS (Blocks Per Second) affect?", options: ["Only block rewards", "Throughput, K parameter, and confirmation times", "Nothing else changes", "Only mining difficulty"], correctIndex: 1, explanation: "BPS affects many parameters: higher BPS means more throughput but K must increase proportionally." },

      // Course 5: Core Data Structures - 4 lessons
      { id: "q-5-1-1", lessonId: "lesson-5-1", question: "How does the UTXO model track ownership?", options: ["Account balances like a bank", "Individual 'coins' that are spent and created", "Credit and debit entries", "Token transfers"], correctIndex: 1, explanation: "UTXO tracks individual unspent outputs like specific bills - receiving creates new UTXOs, spending consumes them." },
      { id: "q-5-2-1", lessonId: "lesson-5-2", question: "What unique property does MuHash have for UTXO verification?", options: ["It's faster than SHA-256", "Adding/removing UTXOs is O(1) without rehashing everything", "It uses less memory", "It's quantum-resistant"], correctIndex: 1, explanation: "MuHash allows incremental updates - adding or removing a UTXO is constant time, no need to rehash the entire set." },
      { id: "q-5-3-1", lessonId: "lesson-5-3", question: "What does the 'Accepted Merkle Root' commit to in Kaspa?", options: ["Just this block's transactions", "All accepted transactions from the block's mergeset", "Only blue block transactions", "Future transactions"], correctIndex: 1, explanation: "The Accepted Merkle Root commits to all accepted transactions from the mergeset, not just the block's own transactions." },
      { id: "q-5-4-1", lessonId: "lesson-5-4", question: "How is the 'Selected Parent' chosen among a block's parents?", options: ["Randomly", "Oldest first", "The one with highest Blue Work", "Smallest block size"], correctIndex: 2, explanation: "The Selected Parent is the tip with highest Blue Work - this determines which chain the new block extends." },

      // Course 6: GHOSTDAG Mechanics - 5 lessons
      { id: "q-6-1-1", lessonId: "lesson-6-1", question: "What factors determine the K parameter value?", options: ["Block reward and fees", "BPS rate, network delay, and security level", "Number of miners", "Transaction volume"], correctIndex: 1, explanation: "K is calculated from blocks per second, network propagation delay, and desired security guarantees." },
      { id: "q-6-2-1", lessonId: "lesson-6-2", question: "Why is parent ordering important in GHOSTDAG?", options: ["For display purposes", "For consistent mergeset creation across all nodes", "For mining rewards", "For transaction fees"], correctIndex: 1, explanation: "Deterministic parent ordering ensures all nodes create the same mergeset for consistent consensus." },
      { id: "q-6-3-1", lessonId: "lesson-6-3", question: "What determines the order of blocks in a mergeset?", options: ["Time received", "Block size", "Blue Work - highest first, then recursively", "Random selection"], correctIndex: 2, explanation: "Mergeset blocks are ordered by Blue Work (highest first), with ties broken by processing order recursively." },
      { id: "q-6-4-1", lessonId: "lesson-6-4", question: "What makes a block classified as 'Blue' in GHOSTDAG?", options: ["It was mined first", "Its anticone size relative to blue set is within K", "It has more transactions", "It has higher fees"], correctIndex: 1, explanation: "Blue blocks have anticone sizes within K relative to existing blue set - indicating honest, well-connected mining." },
      { id: "q-6-5-1", lessonId: "lesson-6-5", question: "What is 'Blue Work' used for in Kaspa?", options: ["Calculating rewards", "Chain selection - picking the canonical chain", "Difficulty adjustment", "Fee calculation"], correctIndex: 1, explanation: "Blue Work is the cumulative proof-of-work from blue blocks - the chain with highest Blue Work is canonical." },

      // Course 7: Consensus Parameters - 6 lessons
      { id: "q-7-1-1", lessonId: "lesson-7-1", question: "What is the formula relationship between BPS and target block time?", options: ["BPS = Block Time", "Target Block Time = 1/BPS", "BPS = Block Size", "No relationship"], correctIndex: 1, explanation: "Target Block Time equals 1 divided by BPS - e.g., 10 BPS means 0.1 second block time." },
      { id: "q-7-2-1", lessonId: "lesson-7-2", question: "Why is there a Mergeset Size Limit?", options: ["To save bandwidth", "To prevent DoS attacks from blocks referencing too many parents", "To limit rewards", "To speed up mining"], correctIndex: 1, explanation: "Without limits, attackers could create blocks referencing thousands of blocks, causing excessive computation." },
      { id: "q-7-3-1", lessonId: "lesson-7-3", question: "What does Merge Depth Bound prevent?", options: ["Fast blocks", "Deep reorganizations of already-finalized transactions", "High fees", "Large blocks"], correctIndex: 1, explanation: "Merge Depth Bound prevents referencing very old blocks, ensuring finalized transactions stay final." },
      ...
      { id: "q-7-5-1", lessonId: "lesson-7-5", question: "What is the DAA Window used for?", options: ["Block rewards", "Calculating difficulty based on recent block times", "Transaction ordering", "Fee estimation"], correctIndex: 1, explanation: "The DAA Window is a sliding window of blocks used to calculate target difficulty for stable block times." },
      { id: "q-7-6-1", lessonId: "lesson-7-6", question: "What gets preserved when a node prunes old block data?", options: ["Everything", "Nothing - full reset", "Block headers, UTXO set, and MuHash commitments", "Only transactions"], correctIndex: 2, explanation: "Pruning removes block bodies but preserves headers, current UTXO set, and MuHash commitments for verification." },

      // Course 8: Block Processing - 2 lessons
      { id: "q-8-1-1", lessonId: "lesson-8-1", question: "What are the four stages of Kaspa's block processing pipeline?", options: ["Mine, broadcast, confirm, spend", "Header validation, Body validation, Virtual chain update, Pruning consideration", "Create, sign, send, receive", "Hash, verify, store, broadcast"], correctIndex: 1, explanation: "Blocks go through: Header validation, Body validation, Virtual chain update, and Pruning consideration." },
      ...
      { id: "q-9-1-1", lessonId: "lesson-9-1", question: "How often does Kaspa adjust mining difficulty?", options: ["Every 2016 blocks like Bitcoin", "Every block", "Once per day", "Never"], correctIndex: 1, explanation: "Kaspa adjusts difficulty every block using a sliding window, allowing quick response to hashrate changes." },
      { id: "q-9-2-1", lessonId: "lesson-9-2", question: "Why does Kaspa use DAA Score separately from Blue Score?", options: ["For marketing", "DAA Score provides accurate time measurement even during attacks", "They are the same", "Historical reasons"], correctIndex: 1, explanation: "DAA Score may include red blocks for accurate elapsed time measurement, while Blue Score only counts honest blocks." },

      // Course 10: Transaction Processing - 3 lessons
      { id: "q-10-1-1", lessonId: "lesson-10-1", question: "Why are fees typically low on Kaspa compared to congested chains?", options: ["No miners", "High BPS means mempool is often empty - less competition for space", "Larger blocks", "Fewer transactions"], correctIndex: 1, explanation: "With high blocks per second, transactions get included quickly and there's less competition for block space." },
      { id: "q-10-2-1", lessonId: "lesson-10-2", question: "What does KIP-9 Storage Mass address?", options: ["Mining efficiency", "UTXO set bloat by charging for creating UTXOs", "Network latency", "Block propagation"], correctIndex: 1, explanation: "Storage Mass (KIP-9) charges for creating UTXOs and credits consuming them, encouraging consolidation." },
      { id: "q-10-3-1", lessonId: "lesson-10-3", question: "What makes coinbase transactions special?", options: ["They have higher fees", "They create new coins with no inputs", "They are faster", "They are reversible"], correctIndex: 1, explanation: "Coinbase transactions are the first in each block - they create new coins from nothing as block rewards." },

      // Course 11: Pruning System - 3 lessons
      { id: "q-11-1-1", lessonId: "lesson-11-1", question: "What does First Order Pruning remove?", options: ["Block headers", "Transaction data and block bodies", "UTXO set", "Proof-of-work"], correctIndex: 1, explanation: "First Order Pruning removes old transaction data and block bodies while preserving headers and UTXO set." },
      { id: "q-11-2-1", lessonId: "lesson-11-2", question: "What additional data does Second Order Pruning remove?", options: ["Nothing more", "Old block headers through checkpoint compression", "Current UTXO set", "Recent transactions"], correctIndex: 1, explanation: "Second Order Pruning removes individual headers at depth, preserving proof-of-work through checkpoints." },
      ...
      { id: "q-12-1-1", lessonId: "lesson-12-1", question: "When is a block's anticone considered 'finalized'?", options: ["Immediately", "When no new blocks can legally reference blocks that would enter its anticone", "After one confirmation", "Never"], correctIndex: 1, explanation: "Anticone is finalized when merge depth bound prevents any new blocks from changing it." },
      { id: "q-12-2-1", lessonId: "lesson-12-2", question: "Why is anticone finalization important for pruning?", options: ["For faster mining", "It guarantees when a block's ordering and status are permanent", "For lower fees", "For more transactions"], correctIndex: 1, explanation: "Once anticone is finalized, the block's final ordering is permanent, making it safe to prune." },

      // Course 13: Virtual State - 2 lessons
      { id: "q-13-1-1", lessonId: "lesson-13-1", question: "What is the 'Virtual Block' in Kaspa?", options: ["A fake block", "An imaginary block that represents the current DAG tip state", "A block with no transactions", "A future block"], correctIndex: 1, explanation: "The Virtual Block is a conceptual block referencing all current tips, representing the DAG's current state." },
      { id: "q-13-2-1", lessonId: "lesson-13-2", question: "How are Virtual Parents selected?", options: ["Randomly", "All current tips become virtual parents", "Only the oldest tip", "Only blue blocks"], correctIndex: 1, explanation: "The Virtual Block references all current tips as parents, merging the entire leading edge of the DAG." },

      // Course 14: Timestamps - 2 lessons
      { id: "q-14-1-1", lessonId: "lesson-14-1", question: "What is Past Median Time (PMT) used for?", options: ["Mining rewards", "Timestamp validation to prevent manipulation", "Transaction ordering", "Fee calculation"], correctIndex: 1, explanation: "Past Median Time provides a manipulation-resistant timestamp reference for validation." },
      { id: "q-14-2-1", lessonId: "lesson-14-2", question: "Why can't block timestamps be arbitrarily set by miners?", options: ["Hardware limitations", "They must be within bounds relative to PMT and current time", "Network rules prevent it", "Other miners would reject them"], correctIndex: 1, explanation: "Timestamps must be greater than PMT and within acceptable bounds of current time." },

      // Course 15: Finality & Security - 3 lessons
      { id: "q-15-1-1", lessonId: "lesson-15-1", question: "How does the K parameter contribute to security?", options: ["It sets transaction fees", "It bounds anticone size to detect attacks while allowing parallelism", "It controls block size", "It adjusts difficulty"], correctIndex: 1, explanation: "K bounds acceptable anticone size - staying within K indicates honest behavior, exceeding it signals potential attacks." },
      ...
      { id: "q-15-3-1", lessonId: "lesson-15-3", question: "Why does Kaspa achieve finality in minutes rather than hours?", options: ["Weaker security", "High BPS means more blocks accumulate quickly", "Fewer nodes to sync", "Smaller blocks"], correctIndex: 1, explanation: "With high blocks per second, sufficient confirmation depth is reached in minutes rather than hours." },
