...
- **KRC-721 NFT Certificates**: Implements non-custodial minting flow, adhering to KRC-721 standard, using IPFS for metadata. Mainnet indexer: https://kaspa-krc721d.kaspa.com/ (KaspacomDAGs). Fee requirements: Deploy = 1,000 KAS minimum, Mint = 10 KAS minimum.
- **On-Chain Protocols**:
